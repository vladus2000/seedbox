...
RUN \
	/install-devel.sh && \
	su - evil -c 'yay -S --needed --noconfirm python2-setuptools flac lame mp3gain sox vorbis-tools vorbisgain whatmp3 jackett wget rsync unzip p7zip zip openssh rar libglvnd ffmpeg radarr sonarr su-exec mylar3 pymedusa par2cmdline nzbget streamlink-git' && \
